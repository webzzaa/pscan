...
func Flag(Info *HostInfo) error {
	...
	// 目标配置参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&Info.Host, "t", "", i18n.GetText("flag_host"))
	flag.StringVar(&fv.ExcludeHosts, "et", "", i18n.GetText("flag_exclude_hosts"))
	flag.StringVar(&fv.ExcludeHostsFile, "etf", "", i18n.GetText("flag_exclude_hosts_file"))
	flag.StringVar(&fv.Ports, "tp", config.MainPorts, i18n.GetText("flag_ports"))
	flag.StringVar(&fv.ExcludePorts, "etp", "", i18n.GetText("flag_exclude_ports"))
	flag.StringVar(&fv.HostsFile, "tf", "", i18n.GetText("flag_hosts_file"))
	flag.StringVar(&fv.PortsFile, "tpf", "", i18n.GetText("flag_ports_file"))

	// ═════════════════════════════════════════════════
	// 扫描控制参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&fv.ScanMode, "st", "all", i18n.GetText("flag_scan_mode"))
	flag.IntVar(&fv.ThreadNum, "tn", 600, i18n.GetText("flag_thread_num"))
	flag.Int64Var(&fv.TimeoutSec, "tm", 3, i18n.GetText("flag_timeout"))
	...
	// 认证与凭据参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&fv.Username, "usr", "", i18n.GetText("flag_username"))
	flag.StringVar(&fv.Password, "pw", "", i18n.GetText("flag_password"))
	flag.StringVar(&fv.AddUsers, "ua", "", i18n.GetText("flag_add_users"))
	flag.StringVar(&fv.AddPasswords, "pa", "", i18n.GetText("flag_add_passwords"))
	flag.StringVar(&fv.UsersFile, "uf", "", i18n.GetText("flag_users_file"))
	flag.StringVar(&fv.PasswordsFile, "pf", "", i18n.GetText("flag_passwords_file"))
	flag.StringVar(&fv.UserPassFile, "up", "", i18n.GetText("flag_userpass_file"))
	flag.StringVar(&fv.HashFile, "hf", "", i18n.GetText("flag_hash_file"))
	flag.StringVar(&fv.HashValue, "hv", "", i18n.GetText("flag_hash_value"))
	flag.StringVar(&fv.Domain, "dm", "", i18n.GetText("flag_domain"))
	flag.StringVar(&fv.SSHKeyPath, "sk", "", i18n.GetText("flag_ssh_key"))

	// ═════════════════════════════════════════════════
	// Web扫描参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&fv.TargetURL, "url", "", i18n.GetText("flag_target_url"))
	flag.StringVar(&fv.URLsFile, "urlf", "", i18n.GetText("flag_urls_file"))
	...
	// 输出与显示控制参数
	// ═════════════════════════════════════════════════
	flag.StringVar(&fv.Outputfile, "out", "result.txt", i18n.GetText("flag_output_file"))
	flag.StringVar(&fv.OutputFormat, "fmt", "txt", i18n.GetText("flag_output_format"))
